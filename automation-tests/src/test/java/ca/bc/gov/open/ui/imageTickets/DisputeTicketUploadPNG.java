...
public class DisputeTicketUploadPNG {
    ...
    public void review(WebElement element, WebDriverWait driverWait, WebDriver driver) throws Exception {
        ...
        element = driverWait.until(ExpectedConditions
                .presenceOfElementLocated(By.xpath(COURT_1_FINE_REDUCTION_XPATH)));
        js1.executeScript("arguments[0].click();", element);
        JavascriptExecutor js2 = (JavascriptExecutor) driver;
        element = driverWait.until(ExpectedConditions
                .presenceOfElementLocated(By.xpath(COURT_2_TIME_TO_PAY_XPATH)));
        js2.executeScript("arguments[0].click();", element);
        Thread.sleep(1000);
        JavascriptExecutor js3 = (JavascriptExecutor) driver;
        element = driverWait.until(ExpectedConditions
                .presenceOfElementLocated(By.xpath(COURT_3_SKIP_XPATH)));
