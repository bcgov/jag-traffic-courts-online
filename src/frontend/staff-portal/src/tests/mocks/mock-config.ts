...
export class MockConfig {
  public static get(): Configuration {
    ...
    return {
      courtLocations: [
        { code: '10264.0007', name: '100 Mile House Law Courts'},
        { code: '9393.0007', name: 'Abbotsford Provincial Court'},
        { code: '104.0007', name: 'Alexis Creek Provincial Court'},
        { code: '105.0007', name: 'Anahim Lake Provincial Court'},
        { code: '50764.0009', name: 'Anvil Centre'},
        { code: '106.0007', name: 'Atlin Provincial Court'},
        { code: '10244.0007', name: 'Bella Bella Provincial Court'},
        { code: '10245.0007', name: 'Bella Coola Provincial Court'},
        { code: '107.0007', name: 'Burns Lake Provincial Court'},
        { code: '9067.0007', name: 'Campbell River Law Courts'},
        { code: '23.0007', name: 'Castlegar Provincial Court'},
        { code: '109.0007', name: 'Chetwynd Provincial Court'},
        { code: '51064.0009', name: 'Chilliwack Cultural Centre'},
        { code: '8824.0007', name: 'Chilliwack Law Courts'},
        { code: '28.0007', name: 'Clearwater Provincial Court'},
        { code: '51514.0009', name: 'Coast Kamloops Hotel & Conference Centre'},
        { code: '9068.0007', name: 'Courtenay Law Courts'},
        { code: '51316.0009', name: 'Cowichan Community Centre'},
        { code: '29.0007', name: 'Cranbrook Law Courts'},
        { code: '77.0007', name: 'Creston Law Courts'},
        { code: '110.0007', name: 'Dawson Creek Law Courts'},
        { code: '111.0007', name: 'Dease Lake Provincial Court'},
        { code: '33414.0007', name: 'Downtown Community Court'},
        { code: '10231.0007', name: 'Duncan Law Courts'},
        { code: '52214.0009', name: 'Erwin Stege Community Centre'},
        { code: '50814.0009', name: 'Evergreen Hall'},
        { code: '78.0007', name: 'Fernie Law Courts'},
        { code: '112.0007', name: 'Fort Nelson Law Courts'},
        { code: '113.0007', name: 'Fort St James Provincial Court'},
        { code: '114.0007', name: 'Fort St John Law Courts'},
        { code: '115.0007', name: 'Fraser Lake Provincial Court'},
        { code: '10232.0007', name: 'Ganges Provincial Court'},
        { code: '10233.0007', name: 'Gold River Provincial Court'},
        { code: '79.0007', name: 'Golden Law Courts'},
        { code: '108.0007', name: 'Good Hope Lake Provincial Court'},
        { code: '80.0007', name: 'Grand Forks Law Courts'},
        { code: '124.0007', name: 'Hazelton Provincial Court'},
        { code: '116.0007', name: 'Houston Provincial Court'},
        { code: '117.0007', name: 'Hudson\'s Hope Provincial Court'},
        { code: '51464.0009', name: 'Inn at the Quay'},
        { code: '81.0007', name: 'Invermere Law Courts'},
        { code: '20263.0007', name: 'Justice Centre (Judicial)'},
        { code: '82.0007', name: 'Kamloops Law Courts'},
        { code: '51164.0009', name: 'Kamloops Thompson River University'},
        { code: '83.0007', name: 'Kelowna Law Courts'},
        { code: '118.0007', name: 'Kitimat Law Courts'},
        { code: '51714.0009', name: 'Kiwanis Performing Arts Centre'},
        { code: '16988.0007', name: 'Klemtu Provincial Court'},
        { code: '10257.0007', name: 'Kwadacha Provincial Court'},
        { code: '52114.0009', name: 'Lillooet Elks Hall'},
        { code: '85.0007', name: 'Lillooet Law Courts'},
        { code: '119.0007', name: 'Lower Post Provincial Court'},
        { code: '120.0007', name: 'Mackenzie Provincial Court'},
        { code: '121.0007', name: 'Masset Provincial Court'},
        { code: '122.0007', name: 'McBride Provincial Court'},
        { code: '51264.0009', name: 'Merritt Civic Centre'},
        { code: '87.0007', name: 'Merritt Law Courts'},
        { code: '51214.0009', name: 'Nakusp & District Sports Complex'},
        { code: '88.0007', name: 'Nakusp Provincial Court'},
        { code: '8805.0007', name: 'Nanaimo Law Courts'},
        { code: '50864.0009', name: 'Nelson Capitol Theatre'},
        { code: '89.0007', name: 'Nelson Law Courts'},
        { code: '123.0007', name: 'New Aiyansh Provincial Court'},
        { code: '8839.0007', name: 'New Westminster Law Courts'},
        { code: '9064.0007', name: 'North Vancouver Provincial Court'},
        { code: '29464.0007', name: 'Office of the Chief Judge'},
        { code: '10246.0007', name: 'Pemberton Provincial Court'},
        { code: '91.0007', name: 'Penticton Law Courts'},
        { code: '52465.0009', name: 'Penticton Seniors Centre'},
        { code: '10235.0007', name: 'Port Alberni Law Courts'},
        { code: '8834.0007', name: 'Port Coquitlam Provincial Court'},
        { code: '10236.0007', name: 'Port Hardy Law Courts'},
        { code: '10237.0007', name: 'Powell River Law Courts'},
        { code: '8844.0007', name: 'Prince George Law Courts'},
        { code: '9075.0007', name: 'Prince Rupert Law Courts'},
        { code: '92.0007', name: 'Princeton Law Courts'},
        { code: '10266.0007', name: 'Queen Charlotte Provincial Court'},
        { code: '9074.0007', name: 'Quesnel Law Courts'},
        { code: '93.0007', name: 'Revelstoke Law Courts'},
        { code: '9062.0007', name: 'Richmond Provincial Court'},
        { code: '10250.0007', name: 'Robson Square Provincial Court'},
        { code: '94.0007', name: 'Rossland Law Courts'},
        { code: '95.0007', name: 'Salmon Arm Law Courts'},
        { code: '10248.0007', name: 'Sechelt Provincial Court'},
        { code: '10238.0007', name: 'Sidney Provincial Court'},
        { code: '9073.0007', name: 'Smithers Law Courts'},
        { code: '10256.0007', name: 'Sparwood Provincial Court'},
        { code: '10267.0007', name: 'Stewart Provincial Court'},
        { code: '8841.0007', name: 'Surrey Provincial Court'},
        { code: '10239.0007', name: 'Tahsis Provincial Court'},
        { code: '9072.0007', name: 'Terrace Law Courts'},
        { code: '51364.0009', name: 'Terrace Sportsplex'},
        { code: '10240.0007', name: 'Tofino Provincial Court'},
        { code: '10258.0007', name: 'Tsay Keh Dene Provincial Court'},
        { code: '10268.0007', name: 'Tumbler Ridge Provincial Court'},
        { code: '10241.0007', name: 'Ucluelet Provincial Court'},
        { code: '9144.0007', name: 'Valemount Provincial Court'},
        { code: '8816.0007', name: 'Vancouver Law Courts'},
        { code: '8813.0007', name: 'Vancouver Provincial Court'},
        { code: '9071.0007', name: 'Vanderhoof Law Courts'},
        { code: '96.0007', name: 'Vernon Law Courts'},
        { code: '8807.0007', name: 'Victoria Law Courts'},
        { code: '31964.0007', name: 'Violation Ticket Centre'},
        { code: '10243.0007', name: 'Western Communities Provincial Court'},
        { code: '51365.0009', name: 'Williams Lake Elks Hall'},
        { code: '9070.0007', name: 'Williams Lake Law Courts'},
        { code: '52615.0009', name: 'Williams Lake MacKinnon Hall'}
      ],
      languages: [
        ...
        { code: 'MAN', name: 'Mandarin' },
        { code: 'PER', name: 'Persian' },
        { code: 'PHI', name: 'Phillipino' },
        { code: 'POR', name: 'Portugese' },
        { code: 'ROM', name: 'Romanian' },
        { code: 'RUS', name: 'Russian' },
        { code: 'SER', name: 'Serbian' },
        { code: 'SOM', name: 'Somalian' },
        ...
        { code: 'CAM', name: 'Cambodian' },
        { code: 'CRO', name: 'Croatian' },
        { code: 'CZE', name: 'Czech' },
        { code: 'HIN', name: 'Hindi' },
        { code: 'IIO', name: 'Iiocano' },
        { code: 'IRI', name: 'Irish' },
        { code: 'KUR', name: 'Kurdish' },
        { code: 'KHM', name: 'Khmer' },
        { code: 'KAS', name: 'Kashubian' },
        { code: 'LAO', name: 'Laotian' },
        { code: 'NOR', name: 'Norwegian' },
        { code: 'PDE', name: 'Pidgin English' },
        { code: 'MDI', name: 'Mandingo' },
        { code: 'SIN', name: 'Sinhalese' },
        { code: 'SLO', name: 'Slovenian' },
        { code: 'SLV', name: 'Slovak' },
        { code: 'SWA', name: 'Swahili' },
        { code: 'TAM', name: 'Tamil' },
        { code: 'THA', name: 'Thai' },
        { code: 'TIG', name: 'Tigrinya' },
        { code: 'URD', name: 'Urdu' },
        { code: 'VIS', name: 'Visayan' },
        { code: 'YUG', name: 'Yugoslavian' },
        { code: 'GUJ', name: 'Gujarati' },
        { code: 'ARM', name: 'Armenian' },
        { code: 'HEB', name: 'Hebrew' },
        { code: 'TAI', name: 'Taiwanese' },
        { code: 'NUB', name: 'Nubian' },
        { code: 'BUL', name: 'Bulgarian' },
        { code: 'FIJ', name: 'Fijian' },
        { code: 'CAR', name: 'Carrier' },
        { code: 'CHL', name: 'Chilcotin' },
      ],
      statuses: [
        {
          code: 0,
