...
export class ViolationTicketService implements IViolationTicketService {
  ...
  public setViolationTicketFromJSON(ocrViolationTicket: OcrViolationTicket, violationTicket: ViolationTicket): ViolationTicket {
    ...
    if (ocrViolationTicket) {
      ...
      if (!violationTicket.disputantDriversLicenceNumber) violationTicket.disputantDriversLicenceNumber = ocrViolationTicket?.fields["disputant_drivers_licence_number"].value;
      ...
      if (ocrViolationTicket?.fields["counts.count_no_1.description"]) {
        const foundViolationTicketCount1 = violationTicket.violationTicketCounts.filter(x => x.countNo == 1);
        if (foundViolationTicketCount1.length > 0) {
          ...
          if (!foundViolationTicketCount1[0].actOrRegulationNameCode) foundViolationTicketCount1[0].actOrRegulationNameCode = ocrViolationTicket?.fields["counts.count_no_1.act_or_regulation"].value;
          ...
          let violationTicketCount = {
            ...
            actOrRegulationNameCode: ocrViolationTicket?.fields["counts.count_no_1.act_or_regulation"].value,
      ...
      if (ocrViolationTicket?.fields["counts.count_no_2.description"]) {
        ...
        if (foundViolationTicketCount2.length > 0) {
          ...
          if (!foundViolationTicketCount2[0].actOrRegulationNameCode) foundViolationTicketCount2[0].actOrRegulationNameCode = ocrViolationTicket?.fields["counts.count_no_2.act_or_regulation"].value;
          ...
          let violationTicketCount = {
            ...
            actOrRegulationNameCode: ocrViolationTicket?.fields["counts.count_no_2.act_or_regulation"].value,
      ...
      if (ocrViolationTicket?.fields["counts.count_no_3.description"]) {
        ...
        if (foundViolationTicketCount3.length > 0) {
          ...
          if (!foundViolationTicketCount3[0].actOrRegulationNameCode) foundViolationTicketCount3[0].actOrRegulationNameCode = ocrViolationTicket?.fields["counts.count_no_3.act_or_regulation"].value;
          ...
          let violationTicketCount = {
            ...
            actOrRegulationNameCode: ocrViolationTicket?.fields["counts.count_no_3.act_or_regulation"].value,
