...
// @ts-ignore
import { EmailHistory } from '../model/emailHistory.model';
// @ts-ignore
...
export class EmailHistoryService {
    ...
    public apiEmailhistoryEmailhistoryGet(ticketNumber?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<Array<EmailHistory>>(`${this.configuration.basePath}/api/emailhistory/emailhistory`,
            {
