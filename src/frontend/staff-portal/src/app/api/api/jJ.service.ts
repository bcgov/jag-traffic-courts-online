...
export class JJService {
     ...
     * @param surnameOrOrgName The case insenstive disputant surname or organization name to search for.
     * @param jjAssignedTo The JJ assigned user
     * @param jjDecisionDtFrom The jj decision date where greater or equal to this date. Format must be YYYY-MM-DD.
     * @param jjDecisionDtThru The jj decision date where less or equal to this date. Format must be YYYY-MM-DD.
     ...
     * @param appearanceDtFrom The appearance date from. Format must be YYYY-MM-DD.
     * @param appearanceDtThru The appearance date thru. Format must be YYYY-MM-DD.
     * @param toBeHeardAtCourthouseIds The comma separate list of agency ids
     * @param hearingTypeCd The hearing type code to search.
     * @param sortBy The list of columns to sort the result by. To sort descending, add a \&#39;-\&#39; before the column name. Note: \&#39;surnameOrOrgName\&#39; is a pseudo field for sorting by surname or organization name.
     * @param pageNumber The page number to fetch. Starts at 1.
     * @param pageSize The page size to use. If not specified, defaults to 25
     * @param fetchPendingAdjournments Whether disputes\&#39; pending adjournment request info should be retrieved, which requires querying COMS documents.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public apiJjDisputesSearchGet(xTimezone?: string, appearances?: boolean, noticeOfHearingYn?: boolean, multipleOfficersYn?: boolean, electronicTicketYn?: boolean, submittedFrom?: string, submittedThru?: string, ticketNumber?: string, surname?: string, surnameOrOrgName?: string, jjAssignedTo?: string, jjDecisionDtFrom?: string, jjDecisionDtThru?: string, disputeStatusCodes?: string, appearanceCourthouseIds?: string, appearanceDtFrom?: string, appearanceDtThru?: string, appearanceRoomCode?: string, toBeHeardAtCourthouseIds?: string, hearingTypeCd?: string, sortBy?: string, pageNumber?: number, pageSize?: number, fetchPendingAdjournments?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<PagedDisputeCaseFileSummaryCollection>;
    public apiJjDisputesSearchGet(xTimezone?: string, appearances?: boolean, noticeOfHearingYn?: boolean, multipleOfficersYn?: boolean, electronicTicketYn?: boolean, submittedFrom?: string, submittedThru?: string, ticketNumber?: string, surname?: string, surnameOrOrgName?: string, jjAssignedTo?: string, jjDecisionDtFrom?: string, jjDecisionDtThru?: string, disputeStatusCodes?: string, appearanceCourthouseIds?: string, appearanceDtFrom?: string, appearanceDtThru?: string, appearanceRoomCode?: string, toBeHeardAtCourthouseIds?: string, hearingTypeCd?: string, sortBy?: string, pageNumber?: number, pageSize?: number, fetchPendingAdjournments?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<PagedDisputeCaseFileSummaryCollection>>;
    public apiJjDisputesSearchGet(xTimezone?: string, appearances?: boolean, noticeOfHearingYn?: boolean, multipleOfficersYn?: boolean, electronicTicketYn?: boolean, submittedFrom?: string, submittedThru?: string, ticketNumber?: string, surname?: string, surnameOrOrgName?: string, jjAssignedTo?: string, jjDecisionDtFrom?: string, jjDecisionDtThru?: string, disputeStatusCodes?: string, appearanceCourthouseIds?: string, appearanceDtFrom?: string, appearanceDtThru?: string, appearanceRoomCode?: string, toBeHeardAtCourthouseIds?: string, hearingTypeCd?: string, sortBy?: string, pageNumber?: number, pageSize?: number, fetchPendingAdjournments?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<PagedDisputeCaseFileSummaryCollection>>;
    public apiJjDisputesSearchGet(xTimezone?: string, appearances?: boolean, noticeOfHearingYn?: boolean, multipleOfficersYn?: boolean, electronicTicketYn?: boolean, submittedFrom?: string, submittedThru?: string, ticketNumber?: string, surname?: string, surnameOrOrgName?: string, jjAssignedTo?: string, jjDecisionDtFrom?: string, jjDecisionDtThru?: string, disputeStatusCodes?: string, appearanceCourthouseIds?: string, appearanceDtFrom?: string, appearanceDtThru?: string, appearanceRoomCode?: string, toBeHeardAtCourthouseIds?: string, hearingTypeCd?: string, sortBy?: string, pageNumber?: number, pageSize?: number, fetchPendingAdjournments?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        if (surnameOrOrgName !== undefined && surnameOrOrgName !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>surnameOrOrgName, 'surname_or_org_name');
        }
        if (jjAssignedTo !== undefined && jjAssignedTo !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>jjAssignedTo, 'jj_assigned_to');
        }
        if (jjDecisionDtFrom !== undefined && jjDecisionDtFrom !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>jjDecisionDtFrom, 'jj_decision_dt_from');
        }
        if (jjDecisionDtThru !== undefined && jjDecisionDtThru !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>jjDecisionDtThru, 'jj_decision_dt_thru');
        }
        ...
        if (appearanceDtFrom !== undefined && appearanceDtFrom !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>appearanceDtFrom, 'appearance_dt_from');
        }
        if (appearanceDtThru !== undefined && appearanceDtThru !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>appearanceDtThru, 'appearance_dt_thru');
        }
        if (appearanceRoomCode !== undefined && appearanceRoomCode !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>appearanceRoomCode, 'appearance_courtroom_code');
        }
        ...
        if (hearingTypeCd !== undefined && hearingTypeCd !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>hearingTypeCd, 'hearing_type_cd');
        }
        ...
        if (fetchPendingAdjournments !== undefined && fetchPendingAdjournments !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>fetchPendingAdjournments, 'fetch_pending_adjournments');
        }
    ...
    public apiJjTicketNumberCascadePut(ticketNumber: string, xTimezone?: string, jJDispute?: JJDispute, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.put<JJDispute>(`${this.configuration.basePath}/api/jj/${this.configuration.encodeParam({name: "ticketNumber", value: ticketNumber, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/cascade`,
            jJDispute,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
    ...
    public apiJjTicketNumberRecallPut(ticketNumber: string, checkVTC?: boolean, xTimezone?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.configuration.basePath}/api/jj/${this.configuration.encodeParam({name: "ticketNumber", value: ticketNumber, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/recall`,
            null,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
    ...
    public apiJjTicketNumberUpdatecourtappearanceConfirmPut(ticketNumber: string, xTimezone?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.configuration.basePath}/api/jj/${this.configuration.encodeParam({name: "ticketNumber", value: ticketNumber, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/updatecourtappearance/confirm`,
            null,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
