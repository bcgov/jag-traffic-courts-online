...
export class DisputeService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiDisputeEmailUuidResendPut(uuid: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<any>;
    public apiDisputeEmailUuidResendPut(uuid: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpResponse<any>>;
    public apiDisputeEmailUuidResendPut(uuid: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<HttpEvent<any>>;
    public apiDisputeEmailUuidResendPut(uuid: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext}): Observable<any> {
        if (uuid === null || uuid === undefined) {
            throw new Error('Required parameter uuid was null or undefined when calling apiDisputeEmailUuidResendPut.');
        }
        ...
        return this.httpClient.put<any>(`${this.configuration.basePath}/api/dispute/email/${this.configuration.encodeParam({name: "uuid", value: uuid, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: "uuid"})}/resend`,
            null,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
