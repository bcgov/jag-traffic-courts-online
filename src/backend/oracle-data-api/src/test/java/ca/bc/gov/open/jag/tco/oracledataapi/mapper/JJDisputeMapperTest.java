...
public class JJDisputeMapperTest extends BaseTestSuite {
	...
	public void testJJDisputeCount() throws Exception {
		...
		String appearanceChargeCountId = "55";
		...
		String suspSntcProbationCondsTxt = "suspSntcProbationCondTxt";
        ...
        disputeCount.setAppearanceChargeCountId(appearanceChargeCountId);
		...
		disputeCount.setJailIntermittentYn(jailIntermittentYn.toString());
		...
		disputeCount.setDismissedForWantProsecYn(dismissedForWantProsecYn.toString());
		disputeCount.setWithdrawnYn(withdrawnYn.toString());
		disputeCount.setAbatementYn(abatementYn.toString());
