...
(4, 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'ST04633443', 'ST04633443', 1, FALSE, '', '124(c)(1) Driving with burned out break lights', 0, TRUE, 5.00, 10.00, TRUE, TRUE, DATEADD('DAY', 45, CURRENT_DATE), null),
(5, 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'ST04633443', 'ST04633443', 2, FALSE, '', '67(b) Excessive speeding', 0, TRUE, 350.0, 300.00, TRUE, TRUE, DATEADD('DAY', 45, CURRENT_DATE), null),
(6, 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'ST04633443', 'ST04633443', 3, FALSE, '', '45(a) Driving without licence', 0, TRUE, 45.00, 47.00, TRUE, TRUE, DATEADD('DAY', 45, CURRENT_DATE), null),
(7, 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'AJ20109246', 'AJ20109246', 1, FALSE, '', '124(c)(1) Driving with burned out break lights', 0, TRUE, 5.00, 3.00, TRUE, TRUE, DATEADD('DAY', 30, CURRENT_DATE), null),
(8, 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'AJ20109246', 'AJ20109246', 2, FALSE, '', '67(b) Excessive speeding', 0, TRUE, 350.0, 300.00, TRUE, TRUE, DATEADD('DAY', 30, CURRENT_DATE), null),
(9, 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'EA02216655', 'EA02216655', 1, FALSE, '', '45(a) Driving without licence', 0, TRUE, 45.00, 40.00, TRUE, TRUE, DATEADD('DAY', 30, CURRENT_DATE), null),
(10, 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'SG00853764', 'SG00853764', 1, FALSE, '', '124(c)(1) Driving with burned out break lights', 0, TRUE, 5.00, 5.00, TRUE, TRUE, DATEADD('DAY', 45, CURRENT_DATE), null),
(11, 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'SG00853764', 'SG00853764', 2, FALSE, '', '67(b) Excessive speeding', 0, TRUE, 350.0, 200.00, TRUE, TRUE, DATEADD('DAY', 45, CURRENT_DATE), null),
(12, 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'SG00853764', 'SG00853764', 3, FALSE, '', '45(a) Driving without licence', 0, TRUE, 45.00, 20.00, TRUE, TRUE, DATEADD('DAY', 45, CURRENT_DATE), null),
(13, 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'AQ22185698', 'AQ22185698', 1, FALSE, '', '124(c)(1) Driving with burned out break lights', 0, TRUE, 5.00, 20.00, TRUE, TRUE, DATEADD('DAY', 30, CURRENT_DATE), null),
(14, 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'AQ22185698', 'AQ22185698', 2, FALSE, '', '67(b) Excessive speeding', 0, TRUE, 350.0, 475.00, TRUE, TRUE, DATEADD('DAY', 30, CURRENT_DATE), null);
