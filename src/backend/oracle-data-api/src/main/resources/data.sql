...
INSERT INTO JJDISPUTE (TICKET_NUMBER, CREATED_BY, CREATED_TS, MODIFIED_BY, MODIFIED_TS, COURTHOUSE_LOCATION, GIVEN_NAMES, SURNAME, OFFENCE_LOCATION, FINE_REDUCTION_REASON, TIME_TO_PAY_REASON, 
  ...
  ('EA022166552', 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'Pemberton Provincial Court', 'Matt', 'Vaughan', 'Golden', 'I have lost my job and I am looking for another one', '', 'Steven Allan', 'ldame@idir', 'JJGroup1', 'Whistler', DATEADD('DAY',-3, CURRENT_DATE), 'IN_PROGRESS', DATEADD('DAY',-3, CURRENT_DATE), DATEADD('DAY',-3, CURRENT_DATE)),
  ('SG008537641', 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'Abbotsford Provincial Court', 'Gavin', 'Glover', 'Brentwood Bay', 'I have lost my job and I am looking for another one', '', 'Harry Reid', 'ldame@idir', 'JJGroup3', 'Ladysmith', DATEADD('DAY',-4, CURRENT_DATE), 'REVIEW', DATEADD('DAY',-4, CURRENT_DATE), DATEADD('DAY',-4, CURRENT_DATE)),
  ('AQ221856981', 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'Chilliwack Provincial Court', 'Gavin', 'Glover', 'Cache Creek', 'I have lost my job and I am looking for another one', '', 'Harry Reid', NULL, NULL, 'Ladysmith', DATEADD('DAY',-5, CURRENT_DATE), 'COMPLETED', DATEADD('DAY',-5, CURRENT_DATE), DATEADD('DAY',-5, CURRENT_DATE));
