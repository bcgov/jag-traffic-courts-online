...
INSERT INTO JJDISPUTE (TICKET_NUMBER, CREATED_BY, CREATED_TS, MODIFIED_BY, MODIFIED_TS, COURTHOUSE_LOCATION, GIVEN_NAMES, SURNAME, OFFENCE_LOCATION, FINE_REDUCTION_REASON, TIME_TO_PAY_REASON, 
  ...
  ('AL89933084', 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'Pemberton Provincial Court', 'John', 'Doe', 'Victoria', 'I have lost my job and I am looking for another one', 'Need my salary to be deposited', 'Steven Allan', 'ldame@idir', 'JJGroup1', 'West Shore', LOCALTIMESTAMP, 'NEW', LOCALTIMESTAMP, LOCALTIMESTAMP),
  ('ST046334431', 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'Vancouver Provincial Court', 'Jane', 'Doe', 'Burnaby', 'I have lost my job and I am looking for another one', 'Need my salary to be deposited', 'Alison Kerr', 'ldame@idir', 'JJGroup2', 'Valemount', DATEADD('DAY',-1, CURRENT_DATE), 'NEW', DATEADD('DAY',-1, CURRENT_DATE), DATEADD('DAY',-1, CURRENT_DATE)),
  ('AJ201092461', 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'Dease Lake Provincial Court', 'Simon', 'Young', 'New Westminister', 'I have lost my job and I am looking for another one', 'Need my salary to be deposited', 'Adrian Peake', NULL, 'JJGroup2', 'University', DATEADD('DAY',-2, CURRENT_DATE), 'NEW', DATEADD('DAY',-2, CURRENT_DATE), DATEADD('DAY',-2, CURRENT_DATE)),
  ('EA022166552', 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'Pemberton Provincial Court', 'Matt', 'Vaughan', 'Golden', 'I have lost my job and I am looking for another one', '', 'Steven Allan', 'ldame@idir', 'JJGroup1', 'Whistler', DATEADD('DAY',-3, CURRENT_DATE), 'NEW', DATEADD('DAY',-3, CURRENT_DATE), DATEADD('DAY',-3, CURRENT_DATE)),
  ('SG008537641', 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'Abbotsford Provincial Court', 'Gavin', 'Glover', 'Brentwood Bay', 'I have lost my job and I am looking for another one', '', 'Harry Reid', 'ldame@idir', 'JJGroup3', 'Ladysmith', DATEADD('DAY',-4, CURRENT_DATE), 'NEW', DATEADD('DAY',-4, CURRENT_DATE), DATEADD('DAY',-4, CURRENT_DATE)),
  ('AQ221856981', 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'Chilliwack Provincial Court', 'Gavin', 'Glover', 'Cache Creek', 'I have lost my job and I am looking for another one', '', 'Harry Reid', NULL, NULL, 'Ladysmith', DATEADD('DAY',-5, CURRENT_DATE), 'NEW', DATEADD('DAY',-5, CURRENT_DATE), DATEADD('DAY',-5, CURRENT_DATE));
