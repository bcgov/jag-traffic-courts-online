...
INSERT INTO JJDISPUTE (TICKET_NUMBER, CREATED_BY, CREATED_TS, MODIFIED_BY, MODIFIED_TS, COURTHOUSE_LOCATION, GIVEN_NAMES, SURNAME, OFFENCE_LOCATION, FINE_REDUCTION_REASON, TIME_TO_PAY_REASON, 
  ...
  ('ST046334431', 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'Vancouver Provincial Court', 'Jane', 'Doe', 'Burnaby', 'I have lost my job and I am looking for another one', 'Need my salary to be deposited', 'Alison Kerr', 'ldame@idir', 'Valemount', DATEADD('DAY',-1, CURRENT_DATE), 'NEW', DATEADD('DAY',-1, CURRENT_DATE), DATEADD('DAY',-1, CURRENT_DATE)),
  ...
  ('EA022166552', 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'Pemberton Provincial Court', 'Matt', 'Vaughan', 'Golden', 'I have lost my job and I am looking for another one', '', 'Steven Allan', 'ldame@idir', 'Whistler', DATEADD('DAY',-3, CURRENT_DATE), 'NEW', DATEADD('DAY',-3, CURRENT_DATE), DATEADD('DAY',-3, CURRENT_DATE)),
  ('SG008537641', 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'Abbotsford Provincial Court', 'Gavin', 'Glover', 'Brentwood Bay', 'I have lost my job and I am looking for another one', '', 'Harry Reid', 'ldame@idir', 'Ladysmith', DATEADD('DAY',-4, CURRENT_DATE), 'NEW', DATEADD('DAY',-4, CURRENT_DATE), DATEADD('DAY',-4, CURRENT_DATE)),
  ('AQ221856981', 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'Chilliwack Provincial Court', 'Gavin', 'Glover', 'Cache Creek', 'I have lost my job and I am looking for another one', '', 'Harry Reid', NULL, 'Ladysmith', DATEADD('DAY',-5, CURRENT_DATE), 'NEW', DATEADD('DAY',-5, CURRENT_DATE), DATEADD('DAY',-5, CURRENT_DATE));
