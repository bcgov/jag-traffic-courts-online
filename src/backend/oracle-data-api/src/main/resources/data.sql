...
INSERT INTO JJDISPUTE (TICKET_NUMBER, CREATED_BY, CREATED_TS, MODIFIED_BY, MODIFIED_TS, COURTHOUSE_LOCATION, GIVEN_NAMES, SURNAME, OFFENCE_LOCATION, FINE_REDUCTION_REASON, TIME_TO_PAY_REASON, 
  ...
  ('EA00241528', 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'Robson Square Provincial Court', 'Francois Robert', 'Hodge', 'Victoria', '', '', 'Steven Allan', 'ldame', 'West Shore', LOCALTIMESTAMP, 'HEARING_SCHEDULED', LOCALTIMESTAMP, LOCALTIMESTAMP, 'COURT_APPEARANCE', 'Bartwell Law & Associates', 'BARTWELL', 'BART', '', '', 'Polish', 4);
