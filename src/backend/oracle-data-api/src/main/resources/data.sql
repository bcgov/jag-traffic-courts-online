...
INSERT INTO JJDISPUTE (TICKET_NUMBER, CREATED_BY, CREATED_TS, MODIFIED_BY, MODIFIED_TS, COURTHOUSE_LOCATION, GIVEN_NAMES, SURNAME, OFFENCE_LOCATION, FINE_REDUCTION_REASON, TIME_TO_PAY_REASON, 
  ...
  ('AO38375804', 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'Robson Square Provincial Court', 'John', 'Doe', 'Victoria', 'Just started a new job', 'Need my salary to be deposited', 'Steven Allan', null, 'West Shore', '2023-12-31T23:59', 'NEW', LOCALTIMESTAMP, LOCALTIMESTAMP, 'WRITTEN_REASONS', '', '', '', '', '', '', 0, 'WRITTEN_REASONS'),
  ...
  ('EA02000460', 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'Victoria Law Courts', 'John', 'Doe', 'Victoria', '', 'Need my salary to be deposited', 'Steven Allan', null, 'West Shore', '2022-12-07T9:54', 'IN_PROGRESS', LOCALTIMESTAMP, LOCALTIMESTAMP, 'WRITTEN_REASONS', '', '', '', '', '', '', 0, 'WRITTEN_REASONS'),
