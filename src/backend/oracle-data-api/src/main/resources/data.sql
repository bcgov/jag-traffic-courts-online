...
INSERT INTO JJDISPUTE (TICKET_NUMBER, CREATED_BY, CREATED_TS, MODIFIED_BY, MODIFIED_TS, COURTHOUSE_LOCATION, GIVEN_NAMES, SURNAME, OFFENCE_LOCATION, FINE_REDUCTION_REASON, TIME_TO_PAY_REASON, 
  ...
  ('EA02000460', 'System', LOCALTIMESTAMP, 'System', LOCALTIMESTAMP, 'Victoria Law Courts', 'John', 'Doe', 'Victoria', '', 'Need my salary to be deposited', 'Steven Allan', null, 'West Shore', '2022-12-06T17:54', 'IN_PROGRESS', LOCALTIMESTAMP, LOCALTIMESTAMP, 'WRITTEN_REASONS', '', '', '', '', '', '', 0, 'WRITTEN_REASONS'),
