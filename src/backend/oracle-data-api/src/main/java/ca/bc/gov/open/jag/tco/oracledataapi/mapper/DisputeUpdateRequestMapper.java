...
public interface DisputeUpdateRequestMapper {
	...
	@Mapping(source = "currentJsonTxt", target = "currentJson")
	@Mapping(source = "statusUpdateDtm", target = "statusUpdateTs")
	...
	@Mapping(target = "currentJsonTxt", source = "currentJson")
	@Mapping(target = "statusUpdateDtm", source = "statusUpdateTs")
