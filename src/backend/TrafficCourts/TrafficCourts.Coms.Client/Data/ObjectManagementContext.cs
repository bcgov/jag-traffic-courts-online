...
namespace TrafficCourts.Coms.Client.Data
{
    ...
    {
        public ObjectManagementContext()
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Models.Metadata>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Key, e.Value }, "metadata_key_value_unique")
                    .IsUnique();
            ...
            modelBuilder.Entity<Tag>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Key, e.Value }, "tag_key_value_unique")
                    .IsUnique();
            ...
            {
                entity.HasKey(e => new { e.VersionId, e.MetadataId })
                    .HasName("version_metadata_pkey");
