...
public partial class ObjectManagementClient
{
    ...
    public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Anonymous>> CreateObjectsAsync(string? x_amz_meta_*, S3TagSet? tagset*, FileParameter anyKey)
    {
        return CreateObjectsAsync(x_amz_meta_ *, tagset *, anyKey, System.Threading.CancellationToken.None);
    }
    ...
    /// <returns>Returns an array of created object data</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Anonymous>> CreateObjectsAsync(string? x_amz_meta_*, S3TagSet? tagset*, FileParameter anyKey, System.Threading.CancellationToken cancellationToken)
    {
        ...
        if (tagset * != null)
        {
            if (tagset[*].Key != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("tagset[*][key]") + "=").Append(System.Uri.EscapeDataString(ConvertToString(tagset[*].Key, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            if (tagset[*].Value != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("tagset[*][value]") + "=").Append(System.Uri.EscapeDataString(ConvertToString(tagset[*].Value, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            foreach (var item_ in tagset[*].AdditionalProperties) { urlBuilder_.Append(System.Uri.EscapeDataString(item_.Key) + "=").Append(System.Uri.EscapeDataString(ConvertToString(item_.Value, System.Globalization.CultureInfo.InvariantCulture))).Append("&"); }
        }
        urlBuilder_.Length--;
        ...
        try
        {
            using (var request_ = new System.Net.Http.HttpRequestMessage())
            {
                ...
                if (x_amz_meta_ * != null)
                    request_.Headers.TryAddWithoutValidation("x-amz-meta-*", ConvertToString(x_amz_meta_ *, System.Globalization.CultureInfo.InvariantCulture));
        ...
        try
        {
            using (var request_ = new System.Net.Http.HttpRequestMessage())
            {
                ...
                try
                {
                    ...
                    if (status_ == 201)
                    {
                        var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<DBObject>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                        if (objectResponse_.Object == null)
                        {
                            throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                        }
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual System.Threading.Tasks.Task<Response> UpdateObjectAsync(string? x_amz_meta_*, System.Guid objId, S3TagSet? tagset*, FileParameter anyKey)
    {
        return UpdateObjectAsync(x_amz_meta_ *, objId, tagset *, anyKey, System.Threading.CancellationToken.None);
    }
    ...
    /// <returns>Returns the updated object data</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<Response> UpdateObjectAsync(string? x_amz_meta_*, System.Guid objId, S3TagSet? tagset*, FileParameter anyKey, System.Threading.CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/object/{objId}?");
        urlBuilder_.Replace("{objId}", System.Uri.EscapeDataString(ConvertToString(objId, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual System.Threading.Tasks.Task AddMetadataAsync(string? x_amz_meta_*, System.Guid objId, string? versionId)
    {
        return AddMetadataAsync(x_amz_meta_ *, objId, versionId, System.Threading.CancellationToken.None);
    }
    ...
    /// <returns>Accepted and no content</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task AddMetadataAsync(string? x_amz_meta_*, System.Guid objId, string? versionId, System.Threading.CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
    ...
    /// <returns>Accepted and no content</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual System.Threading.Tasks.Task ReplaceMetadataAsync(string? x_amz_meta_*, System.Guid objId, string? versionId)
    {
        return ReplaceMetadataAsync(x_amz_meta_ *, objId, versionId, System.Threading.CancellationToken.None);
    }
    ...
    /// <returns>Accepted and no content</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task ReplaceMetadataAsync(string? x_amz_meta_*, System.Guid objId, string? versionId, System.Threading.CancellationToken cancellationToken)
    {
        if (objId == null)
            throw new System.ArgumentNullException("objId");
    ...
    /// <returns>Accepted and no content</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual System.Threading.Tasks.Task DeleteMetadataAsync(string? x_amz_meta_*, System.Guid objId, string? versionId)
    {
        return DeleteMetadataAsync(x_amz_meta_ *, objId, versionId, System.Threading.CancellationToken.None);
    }
    ...
    /// <returns>Accepted and no content</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task DeleteMetadataAsync(string? x_amz_meta_*, System.Guid objId, string? versionId, System.Threading.CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/object/{objId}/metadata?");
        urlBuilder_.Replace("{objId}", System.Uri.EscapeDataString(ConvertToString(objId, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Anonymous2>> FetchMetadataForObjectAsync(string? x_amz_meta_*, System.Guid? objId)
    {
        return FetchMetadataForObjectAsync(x_amz_meta_ *, objId, System.Threading.CancellationToken.None);
    }
    ...
    /// <returns>Returns an array of objects with matching key/value pairs.</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Anonymous2>> FetchMetadataForObjectAsync(string? x_amz_meta_*, System.Guid? objId, System.Threading.CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
    ...
    /// <returns>Accepted and no content</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual System.Threading.Tasks.Task AddTaggingAsync(System.Guid objId, S3TagSet? tagset*, string? versionId)
    {
        return AddTaggingAsync(objId, tagset *, versionId, System.Threading.CancellationToken.None);
    }
    ...
    /// <returns>Accepted and no content</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task AddTaggingAsync(System.Guid objId, S3TagSet? tagset*, string? versionId, System.Threading.CancellationToken cancellationToken)
    {
        if (objId == null)
            throw new System.ArgumentNullException("objId");
    ...
    /// <returns>Accepted and no content</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual System.Threading.Tasks.Task ReplaceTaggingAsync(System.Guid objId, S3TagSet? tagset*, string? versionId)
    {
        return ReplaceTaggingAsync(objId, tagset *, versionId, System.Threading.CancellationToken.None);
    }
    ...
    /// <returns>Accepted and no content</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task ReplaceTaggingAsync(System.Guid objId, S3TagSet? tagset*, string? versionId, System.Threading.CancellationToken cancellationToken)
    {
        if (objId == null)
            throw new System.ArgumentNullException("objId");
    ...
    /// <returns>Accepted and no content</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual System.Threading.Tasks.Task DeleteTaggingAsync(System.Guid objId, S3TagSet? tagset*, string? versionId)
    {
        return DeleteTaggingAsync(objId, tagset *, versionId, System.Threading.CancellationToken.None);
    }
    ...
    /// <returns>Accepted and no content</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task DeleteTaggingAsync(System.Guid objId, S3TagSet? tagset*, string? versionId, System.Threading.CancellationToken cancellationToken)
    {
        if (objId == null)
            throw new System.ArgumentNullException("objId");
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<DBObjectPermission>> ObjectSearchPermissionsAsync(System.Guid? bucketId, System.Guid? objId, System.Guid? userId, PermCode? permCode)
    {
        return ObjectSearchPermissionsAsync(bucketId, objId, userId, permCode, System.Threading.CancellationToken.None);
    }
    ...
    /// </summary>
    /// <remarks>
    /// Returns an array of bucket permissions meeting the filtering parameters provided
    /// </remarks>
    /// <param name="objectPerms">Boolean representing whether to include (object) buckets or not</param>
    /// <param name="bucketId">Uuid or array of uuids representing the bucket</param>
    /// <param name="userId">Uuid or array of uuids representing the user</param>
    /// <param name="permCode">the permission type</param>
    /// <returns>Returns an array of objectId/userId/permCode triplets that match the provided parameters</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<DBBucketPermission>> BucketSearchPermissionsAsync(bool? objectPerms, System.Guid? bucketId, System.Guid? userId, PermCode? permCode)
    {
        return BucketSearchPermissionsAsync(objectPerms, bucketId, userId, permCode, System.Threading.CancellationToken.None);
    }
    ...
    /// <returns>Returns an array of objectId/userId/permCode triplets that match the provided parameters</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<DBBucketPermission>> BucketSearchPermissionsAsync(bool? objectPerms, System.Guid? bucketId, System.Guid? userId, PermCode? permCode, System.Threading.CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<DBBucketPermission>> BucketListPermissionsAsync(System.Guid bucketId, System.Guid? userId, PermCode? permCode)
    {
        return BucketListPermissionsAsync(bucketId, userId, permCode, System.Threading.CancellationToken.None);
    }
    ...
    /// <returns>Returns an array of bucketId/userId/permCode triplets that match the provided parameters</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<DBBucketPermission>> BucketListPermissionsAsync(System.Guid bucketId, System.Guid? userId, PermCode? permCode, System.Threading.CancellationToken cancellationToken)
    {
        if (bucketId == null)
    ...
    /// <summary>
    /// Returns a list of matching tags for objects
    /// </summary>
    /// <remarks>
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<S3TagSet>> FethTagsForObjectsAsync(S3TagSet? tagset*)
    {
        return FethTagsForObjectsAsync(tagset *, System.Threading.CancellationToken.None);
    }
    ...
    /// <returns>Returns an array of matching key/value pairs.</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<S3TagSet>> FethTagsForObjectsAsync(S3TagSet? tagset*, System.Threading.CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
        ...
        try
        {
            using (var request_ = new System.Net.Http.HttpRequestMessage())
            {
                ...
                try
                {
                    ...
                    if (status_ == 200)
                    {
                        var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<S3TagSet>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                        if (objectResponse_.Object == null)
                        {
                            throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                        }
    ...
    /// <summary>
    /// Returns a list of matching metadata for versions
    /// </summary>
    /// <remarks>
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Anonymous3>> FetchMetadataForVersionAsync(string? x_amz_meta_*, System.Guid? versionId)
    {
        return FetchMetadataForVersionAsync(x_amz_meta_ *, versionId, System.Threading.CancellationToken.None);
    }
    ...
    /// <returns>Returns an array of versions with matching key/value pairs.</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Anonymous3>> FetchMetadataForVersionAsync(string? x_amz_meta_*, System.Guid? versionId, System.Threading.CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
    ...
    /// <returns>Returns an array of matching key/value pairs.</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<S3TagSet>> SearchMetadataAsync(string? x_amz_meta_*)
    {
        return SearchMetadataAsync(x_amz_meta_ *, System.Threading.CancellationToken.None);
    }
    ...
    /// <returns>Returns an array of matching key/value pairs.</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<S3TagSet>> SearchMetadataAsync(string? x_amz_meta_*, System.Threading.CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
    ...
    /// <summary>
    /// Returns a list of matching tags for versions
    /// </summary>
    /// <remarks>
    /// Gets a tags matching the given versions. Multiple Key/Value pairs can be provided in the headers to narrow down results. If none are provided the full set of tags will be returned.
    /// </remarks>
    /// <param name="tagset*">Tags for the object, defined as a Key/Value tag. The query must be formatted in deepObject style notation, where a tag-set made out of multiple tags would be encoded something similar to `tagset[x]=a&amp;tagset[y]=b`. Only one value can exist for a given tag key.</param>
    /// <param name="versionId">Request a specified version</param>
    /// <returns>Returns an array of versions with matching key/value pairs.</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Anonymous4>> FetchTagsForVersionAsync(S3TagSet? tagset*, System.Guid? versionId)
    {
        return FetchTagsForVersionAsync(tagset *, versionId, System.Threading.CancellationToken.None);
    }
    ...
    /// <returns>Returns an array of versions with matching key/value pairs.</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Anonymous4>> FetchTagsForVersionAsync(S3TagSet? tagset*, System.Guid? versionId, System.Threading.CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
    ...
    /// <returns>Returns an array of matching key/value pairs.</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<S3TagSet>> SearchTagsAsync(S3TagSet? tagset*)
    {
        return SearchTagsAsync(tagset *, System.Threading.CancellationToken.None);
    }
    ...
    /// <returns>Returns an array of matching key/value pairs.</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
    public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<S3TagSet>> SearchTagsAsync(S3TagSet? tagset*, System.Threading.CancellationToken cancellationToken)
    {
        var urlBuilder_ = new System.Text.StringBuilder();
