...
/// </summary>
public partial class EmailVerificationSuccessfulConsumer : IConsumer<EmailVerificationSuccessful>
{
    private readonly ILogger<EmailVerificationSuccessfulConsumer> _logger;
    ...
    public EmailVerificationSuccessfulConsumer(
        ...
        ILogger<EmailVerificationSuccessfulConsumer> logger)
    {
