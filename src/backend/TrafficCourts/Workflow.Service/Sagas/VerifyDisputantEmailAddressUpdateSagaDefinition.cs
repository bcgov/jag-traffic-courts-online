...
public class VerifyDisputantEmailAddressUpdateSagaDefinition : SagaDefinition<VerifyDisputantEmailAddressUpdateSagaState>
{
    protected override void ConfigureSaga(IReceiveEndpointConfigurator endpointConfigurator, ISagaConfigurator<VerifyDisputantEmailAddressUpdateSagaState> sagaConfigurator)
    {
