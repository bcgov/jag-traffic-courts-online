...
public class PrintDigitalCaseFileService : IPrintDigitalCaseFileService
{
    ...
    /// </summary>
    public async Task<RenderedReport> PrintDigitalCaseFileAsync(string ticketNumber, TimeZoneInfo timeZone, CancellationToken cancellationToken)
    {
    ...
    public async Task<RenderedReport> PrintTicketValidationViewAsync(long disputeId, TimeZoneInfo timeZone, CancellationToken cancellationToken)
    {
