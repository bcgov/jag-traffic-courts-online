...
public interface IJJDisputeService
{
    ...
    Task<JJDispute> GetJJDisputeAsync(long jjDisputeId, bool assignVTC, CancellationToken cancellationToken);
    ...
    Task AssignJJDisputesToJJ(List<long> jjDisputeIds, string? username, ClaimsPrincipal user, CancellationToken cancellationToken);
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    /// <exception cref="ArgumentNullException">Thrown if ticketNumber is null</exception>
    Task<JJDispute> ReviewJJDisputeAsync(long jjDisputeId, string remark, bool checkVTC, ClaimsPrincipal user, CancellationToken cancellationToken);
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    /// <exception cref="ArgumentNullException">Thrown if ticketNumber is null</exception>
    Task<JJDispute> RequireCourtHearingJJDisputeAsync(long jjDisputeId, string? remark, ClaimsPrincipal user, CancellationToken cancellationToken);
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    /// <exception cref="ArgumentNullException">Thrown if ticketNumber is null</exception>
    Task<JJDispute> AcceptJJDisputeAsync(long jjDisputeId, bool checkVTC, ClaimsPrincipal user, CancellationToken cancellationToken);
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    /// <exception cref="ArgumentNullException">Thrown if ticketNumber is null</exception>
    Task<JJDispute> ConfirmJJDisputeAsync(long jjDisputeId, ClaimsPrincipal user, CancellationToken cancellationToken);
}
