...
public interface IJJDisputeService
{
    ...
    Task<ICollection<JJDispute>> GetAllJJDisputesAsync(string? jjAssignedTo, TimeZoneInfo timeZone, CancellationToken cancellationToken);
    ...
    Task<JJDispute> GetJJDisputeAsync(string ticketNumber, bool assignVTC, TimeZoneInfo timeZone, CancellationToken cancellationToken);
    ...
    Task<JJDispute> UpdateJJDisputeCascadeAsync(JJDispute jjDispute, ClaimsPrincipal user, TimeZoneInfo timeZone, CancellationToken cancellationToken);
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    /// <exception cref="ArgumentNullException">Thrown if ticketNumber is null</exception>
    Task<JJDispute> SubmitAdminResolutionAsync(long jjDisputeId, bool checkVTC, JJDispute jjDispute, ClaimsPrincipal user, TimeZoneInfo timeZone, CancellationToken cancellationToken);
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    /// <exception cref="ArgumentNullException">Thrown if ticketNumber is null</exception>
    Task<JJDispute> ReviewJJDisputeAsync(string ticketNumber, string remark, bool checkVTC, ClaimsPrincipal user, bool recalled, TimeZoneInfo timeZone, CancellationToken cancellationToken);
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    /// <exception cref="ArgumentNullException">Thrown if ticketNumber is null</exception>
    Task<JJDispute> RequireCourtHearingJJDisputeAsync(string ticketNumber, string? remark, ClaimsPrincipal user, TimeZoneInfo timeZone, CancellationToken cancellationToken);
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    /// <exception cref="ArgumentNullException">Thrown if ticketNumber is null</exception>
    Task<JJDispute> AcceptJJDisputeAsync(string ticketNumber, bool checkVTC, ClaimsPrincipal user, TimeZoneInfo timeZone, CancellationToken cancellationToken);
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    /// <exception cref="ArgumentNullException">Thrown if ticketNumber is null</exception>
    Task<JJDispute> ConcludeJJDisputeAsync(string ticketNumber, bool checkVTC, ClaimsPrincipal user, TimeZoneInfo timeZone, CancellationToken cancellationToken);
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    /// <exception cref="ArgumentNullException">Thrown if ticketNumber is null</exception>
    Task<JJDispute> CancelJJDisputeAsync(string ticketNumber, bool checkVTC, ClaimsPrincipal user, TimeZoneInfo timeZone, CancellationToken cancellationToken);
    ...
    /// <exception cref="ApiException">A server side error occurred.</exception>
    /// <exception cref="ArgumentNullException">Thrown if ticketNumber is null</exception>
    Task<JJDispute> ConfirmJJDisputeAsync(string ticketNumber, ClaimsPrincipal user, TimeZoneInfo timeZone, CancellationToken cancellationToken);
