...
public class Cache
{
    ...
    public static class Keycloak
    {
        ...
        /// <returns></returns>
        public static string UsersByGroup(string group, int version = 1) => $"v{version}:groups:{group}";
        ...
        /// <param name="version">The version of the data structure. If new data structure is used, defined a new version. Defaults to 1.</param>
        /// <returns></returns>
        public static string UsersByUsername(string user, int version = 1) => $"v{version}:users:{user}";
    }
    ...
    public static class OracleData
    {
        ...
        /// </summary>
        /// <param name="version">The version of the data structure. If new data structure is used, defined a new version. Defaults to 1.</param>
        public static string DisputeListItems(int version = 1) => $"v{version}:all:dispute-list-items";
    }
}
