...
public class DocumentController : ControllerBase
{
    ...
    /// <param name="guidHash">The guidHash to associate with this file.</param>
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (string.IsNullOrEmpty(guidHash) || !_hashids.TryDecodeGuid(guidHash, out Guid noticeOfDisputeId))
        {
            ...
            problemDetails.Title = "Exception Invoking COMS - Metadata Key does not contain notice-of-dispute-id";
