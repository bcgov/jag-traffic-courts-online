...
public static class ValidationMessages
{
    ...
    public static readonly string TicketNumberInvalid = @"Violation ticket number must start with an A or B and be of the form 'AX00000000'.";
    ...
    public static readonly string MVAMustBeSelectedError = @"MVA or MVAR must be selected under the 'Did commit the offence(s) indicated' section.";
    ...
    public static readonly string OnlyMVAMustBeSelectedError = @"MVA or MVAR must be the only selected ACT under the 'Did commit the offence(s) indicated' section.";
