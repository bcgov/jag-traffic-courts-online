...
public class OcrViolationTicket
{
    ...
    public static readonly string Count1Section = "counts.count_no_1.full_section";
    ...
    public static readonly string Count2Section = "counts.count_no_2.full_section";
    ...
    public static readonly string Count3Section = "counts.count_no_3.full_section";
