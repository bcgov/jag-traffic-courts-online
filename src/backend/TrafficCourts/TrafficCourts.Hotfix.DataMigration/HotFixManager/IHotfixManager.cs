namespace TrafficCourts.Hotfix.DataMigration.Hotfixes
{
    ...
    public interface IHotfixManager
    {
        ...
        Task<dynamic> ExecuteHotfixAsync(string name, string fixVersion, bool dryRun, string environment, int batchSize, Dictionary<string, object> additionalData, CancellationToken cancellationToken);
