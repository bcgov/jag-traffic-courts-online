using Oracle = TrafficCourts.Common.OpenAPIs.OracleDataApi.v1_0;
...
public class OracleDomainModelMappingProfile : AutoMapper.Profile
{
    public OracleDomainModelMappingProfile()
    {
        ...
        // classes
        CreateMap<Oracle.BoundingBox, DomainModel.BoundingBox>().ReverseMap();
        CreateMap<Oracle.Dispute, DomainModel.Dispute>().ReverseMap();
        ...
        CreateMap<Oracle.Field, DomainModel.Field>().ReverseMap();
        CreateMap<Oracle.FileHistory, DomainModel.FileHistory>().ReverseMap();
        CreateMap<Oracle.JJDispute, DomainModel.JJDispute>().ReverseMap();
        ...
        CreateMap<Oracle.OcrViolationTicket, DomainModel.OcrViolationTicket>().ReverseMap();
        CreateMap<Oracle.Point, DomainModel.Point>().ReverseMap();
        CreateMap<Oracle.TicketImageDataJustinDocument, DomainModel.TicketImageDataJustinDocument>().ReverseMap();
        CreateMap<Oracle.ViolationTicket, DomainModel.ViolationTicket>().ReverseMap();
        CreateMap<Oracle.ViolationTicketCount, DomainModel.ViolationTicketCount>().ReverseMap();
        CreateMap<Oracle.ViolationTicketImage, DomainModel.ViolationTicketImage>().ReverseMap();
