...
namespace TrafficCourts.Common.OpenAPIs.OracleDataApi.v1_0
{
    ...
    public partial interface IOracleDataApiClient
    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Dispute>> GetDisputesByEmailVerificationTokenAsync(string emailVerificationToken);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Dispute>> GetDisputesByEmailVerificationTokenAsync(string emailVerificationToken, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class OracleDataApiClient : IOracleDataApiClient
    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Dispute>> GetDisputesByEmailVerificationTokenAsync(string emailVerificationToken)
        {
            return GetDisputesByEmailVerificationTokenAsync(emailVerificationToken, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Dispute>> GetDisputesByEmailVerificationTokenAsync(string emailVerificationToken, System.Threading.CancellationToken cancellationToken)
        {
            if (emailVerificationToken == null)
                throw new System.ArgumentNullException("emailVerificationToken");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("api/v1.0/disputesByEmailVerificationToken/{emailVerificationToken}");
            urlBuilder_.Replace("{emailVerificationToken}", System.Uri.EscapeDataString(ConvertToString(emailVerificationToken, System.Globalization.CultureInfo.InvariantCulture)));
