...
namespace TrafficCourts.Common.OpenAPIs.OracleDataApi.v1_0
{
    ...
    public partial interface IOracleDataApiClient
    {
        ...
        /// <param name="jjAssignedTo">If specified, will retrieve the written Reasons records which are assigned to the specified jj staff</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
    ...
    public partial class JJDisputedCountRoP
    {
        ...
        [Newtonsoft.Json.JsonProperty("jjRemarks", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
