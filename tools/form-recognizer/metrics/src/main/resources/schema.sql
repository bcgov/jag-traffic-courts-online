...
CREATE SEQUENCE GLOBAL_VALIDATION_ERROR_SEQ START WITH 1 INCREMENT BY 1;
CREATE TABLE GLOBAL_VALIDATION_ERROR (
	GLOBAL_VALIDATION_ERROR_ID INT NOT NULL,
	DOCUMENT_ID INTEGER,
	ERROR VARCHAR(1000),
	PRIMARY KEY (GLOBAL_VALIDATION_ERROR_ID),
	FOREIGN KEY (DOCUMENT_ID) REFERENCES DOCUMENT (DOCUMENT_ID) ON DELETE CASCADE
	);